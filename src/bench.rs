...
#[bench]
fn rs_insertion_sort_bench_10(b: &mut Bencher) {
    benchmark_rs!(b, insertion_sort_rs, 10);
}

#[bench]
fn rs_insertion_sort_bench_100(b: &mut Bencher) {
    benchmark_rs!(b, insertion_sort_rs, 100);
}

#[bench]
fn rs_insertion_sort_bench_1000(b: &mut Bencher) {
    benchmark_rs!(b, insertion_sort_rs, 1000);
}
